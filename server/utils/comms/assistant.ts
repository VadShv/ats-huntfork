...
export async function generateAssistantText(
  ...
  const systemParts = [
    opts.autopilot
      ? `Ты — ${personaName}, ${personaRole}. Ты ОТ ИМЕНИ рекрутёра автоматически отвечаешь кандидату в чате по вакансии. Если вопрос требует решения человека или информации, которой нет в контексте, — вежливо ответь, что уточнишь у рекрутёра и вернёшься с ответом.`
