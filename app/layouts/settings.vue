...
<template>
  <div class="flex min-h-screen flex-col bg-surface-50 dark:bg-surface-950">
    ...
    <ClientOnly><ViewAsBanner /></ClientOnly>
    <AppToasts />
    ...
    >
      ...
      <span>
        <strong>Демоверсия</strong> — Свободно изучайте на тестовых данных. Редактирование здесь отключено.
        <a
        ...
        >Развернуть свой бесплатный экземпляр →</a>
      </span>
    </div>
