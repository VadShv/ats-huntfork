...
import { MessageSquare, Users, Eye, Bot, ShieldAlert, ArrowDown } from 'lucide-vue-next'
...
const { showJumpFab, scrollToBottom } = useThreadScroll(scrollRef, computed(() => renderUnits.value.length))
