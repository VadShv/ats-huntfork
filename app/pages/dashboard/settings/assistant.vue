 ...
 * черновики ответов в чате, отправляет всегда рекрутер.
 */
  ...
  <div class="mx-auto max-w-3xl px-4 sm:px-6 py-8">
    <div class="flex items-center gap-3 mb-1">
      ...
      <div>
        ...
        <p class="text-xs text-surface-400 dark:text-surface-500">Суфлёр готовит черновики ответов кандидатам — отправляет всегда рекрутер</p>
      </div>
    </div>
