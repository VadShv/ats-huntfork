...
import {
  ...
  Briefcase, Users, GripVertical, ChevronRight,
  AlertTriangle, MessageSquare, Timer,
    ...
    <div v-else-if="pipeline" class="max-w-6xl mx-auto px-6 py-8">
        ...
        >
          ...
          <div class="flex items-center gap-3 px-5 py-4">
            ...
            <div class="flex items-center gap-1">
              ...
              >
                {{ activeTab === 'rejected' ? 'Причина отказа' : 'Подстатус' }}
              </UiButton>
            </div>
          </div>
      ...
      >
        ...
        <div class="text-sm text-blue-800 dark:text-blue-200">
          <p class="font-medium">Это основная (каноническая) воронка</p>
          <p class="mt-1 opacity-80">
            ...
            Можно добавлять <strong>подстатусы</strong> к существующим этапам — они сразу появятся во всех вакансиях.
            Новые корневые этапы в основной воронке недоступны. Для экспериментов клонируйте воронку в песочницу.
          </p>
        </div>
      </div>
    </div>
